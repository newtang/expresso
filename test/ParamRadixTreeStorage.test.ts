import { Node as ParamRadixTreeStorage } from '../src/storage/ParamRadixTreeStorage';
...
describe('param radix tree storage tests', () => {
  test('1 param in middle', () => {
    ...
    expect(node.search('get', '/v1/api/users/coolUserId/settings')).toStrictEqual({
      target,
      params: { userId: 'coolUserId' },
    });
  ...
  test('end param, with and without slash - short then long', () => {
    ...
    expect(node.search('get', '/v1/api/users/coolUserId')).toStrictEqual({
      target: 'jackpot1',
      params: { userId: 'coolUserId' },
    });
    expect(node.search('get', '/v1/api/users/otherUserId/')).toStrictEqual({
      target: 'jackpot2',
  ...
  test('begin param', () => {
    ...
    expect(node.search('get', '/anything')).toStrictEqual({
      target: 'jackpot1',
      params: { param: 'anything' },
    });
    expect(node.search('get', '/anything/')).toStrictEqual({
      target: 'jackpot2',
      params: { param: 'anything' },
  ...
  test('multiple params back-to-back - short then long', () => {
    ...
    expect(node.search('get', '/v1/api/users/id1/abcd')).toStrictEqual({
      target: 'jackpot1',
      params: { userId: 'id1', objectId: 'abcd' },
    });
    expect(node.search('get', '/v1/api/users/id2/1234/settings')).toStrictEqual({
      target: 'jackpot2',
      params: { userId: 'id2', objectId: '1234' },
    });
  ...
  test('multiple params back-to-back - long then short', () => {
    ...
    expect(node.search('get', '/v1/api/users/id1/abcd/settings')).toStrictEqual({
      target: 'jackpot1',
      params: { userId: 'id1', objectId: 'abcd' },
    });
    expect(node.search('get', '/v1/api/users/id2/1234')).toStrictEqual({
      target: 'jackpot2',
      params: { userId: 'id2', objectId: '1234' },
    });
  ...
  test('same param position, but different name', () => {
    ...
    expect(node.search('get', '/v1/api/users/id1')).toStrictEqual({
      target: 'jackpot1',
      params: { userId: 'id1' },
    });
    expect(node.search('get', '/v1/api/users/id2/path')).toStrictEqual({
      target: 'jackpot2',
      params: { someOtherId: 'id2' },
    });
  ...
  test('short then long #2', () => {
    ...
    expect(node.search('get', '/v1/a/bbb/users/id1')).toStrictEqual({
      target: 'jackpot2',
      params: { id: 'id1' },
    });
  ...
  test('long, different roots', () => {
    ...
    expect(node.search('get', '/api/v1/food/desserts/cookies/1')).toStrictEqual({
      target: 'jackpot1',
      params: { id: '1' },
    });
    expect(node.search('get', '/api/v1/food/dinners/pasta/2')).toStrictEqual({
      target: 'jackpot2',
      params: { id: '2' },
    });
    expect(node.search('get', '/api/v1/food/desserts/icecream/3')).toStrictEqual({
      target: 'jackpot3',
      params: { id: '3' },
    });
    expect(node.search('get', '/api/v1/food/breakfasts/cereal/4')).toStrictEqual({
      target: 'jackpot4',
      params: { id: '4' },
    });
  ...
  test('identical routes, different methods', () => {
    ...
    expect(node.search('post', '/api/v1/hello')).toStrictEqual({
      target: 'jackpot2',
      params: { id: 'hello' },
    });
